...
INSERT INTO unit_profile VALUES(106501,'카야','16','드래곤즈 네스트','드래곤족','156','???','6','25','B','격투기','코이치 마코토',0,'주먹으로 이야기하는 싸움꾼 드래곤 소녀','','17');
INSERT INTO unit_profile VALUES(106601,'이노리','13','드래곤즈 네스트','드래곤족','145','???','9','29','AB','게임','후지타 아카네',0,'말 잘하는 허접한 드래곤','','17');
INSERT INTO unit_profile VALUES(106701,'호마레','25','드래곤즈 네스트','드래곤족','168','???','4','17','O','그림 그리기, 독서','오오니시 사오리',0,'???????','','17');
...
INSERT INTO unit_profile VALUES(111401,'루나','??','???','휴먼족','142','28','?','?','?','「친구」 찾기','오구라 유이',0,'친구를 찾는 사령술사 소녀','','');
INSERT INTO unit_profile VALUES(111501,'크리스티나(크리스마스)','27','왕궁기사단(NIGHTMARE)','휴먼족','165','??','2','7','O','강적과의 투쟁','타카하시 치아키',0,'방약무인한 왕궁기사단 부단장','','8');
INSERT INTO unit_profile VALUES(111601,'노조미(크리스마스)','17','카르미나','휴먼족','157','40','1','24','B','무대 감상, 댄스','히카사 요코',0,'가창력과 안무를 겸비한 대인기 아이돌','','4');
INSERT INTO unit_profile VALUES(111701,'이리야(크리스마스)','??','악마왕국군(디아볼로스)','마족','172','50','5','5','A','세계 정복','탄게 사쿠라',0,'한때 밤을 지배했던 최강의 뱀파이어','','7');
INSERT INTO unit_profile VALUES(111901,'콧코로(새해)','11','미식전','엘프족','140','35','5','11','B','명상, 동식물 기르기','이토 미쿠',0,'주인님을 모시는 꼬마 가이드','주인님의 가이드 역을 맡게 되었습니다\n주인님이 만족하실 수 있도록\n성심성의를 다해 모시도록 하겠습니다','1');
INSERT INTO unit_profile VALUES(112001,'캬루(새해)','14','미식전','수인족','152','39','9','2','A','고양이와 놀기','타치바나 리카',0,'길가에 쓰러진 의문의 고양이 귀를 가진 마법사','뭘 꾸물거리고 있는 거야\n할 수 없으니, 내가 도와줄게\n알겠어? 고마워하라구!','1');
INSERT INTO unit_profile VALUES(112101,'스즈메(새해)','15','사렌디아 구호원','휴먼족','154','43','12','12','O','봉사활동','유우키 아오이',0,'아가씨를 위해 노력하는 덜렁이 메이드','으으… 죄송해요~\n또 부엌을 폭발시켜 버렸어요~\n이래선 메이드 실격이에요…','9');
INSERT INTO unit_profile VALUES(112201,'카스미(매지컬)','18','자경단(카온)','수인족','152','41','11','3','AB','독서, 추리','미나세 이노리',0,'두뇌 명석한 미소녀 탐정','','10');
INSERT INTO unit_profile VALUES(112301,'시오리(매지컬)','14','목장(엘리자베스 파크)','수인족','153','40','11','3','A','독서, 산책','코시미즈 아미',0,'독서가 취미인 연약한 소녀','콜록, 콜록… 모, 몸은 약하지만\n적어도 마음만은 긍정적으로…!\n 앗, 하지만 안 되겠어… 현기증이…','11');
INSERT INTO unit_profile VALUES(180401,'페코린느(프린세스)','17','미식전','휴먼족','156','46','3','31','O','맛집 탐방, 요리','M・A・O',0,'언제나 명랑한 먹보 소녀','저, 저기… 뭔가 먹을 거 없나요?\n 벌써 배가 꼬르륵거려서…','1');
COMMIT;
